...
import com.ywsoftware.oa.common.partner.emay.sdkhttp.Mo;
import com.ywsoftware.oa.common.partner.emay.sdkhttp.SDKServiceBindingStub;
import com.ywsoftware.oa.common.partner.emay.sdkhttp.SDKServiceLocator;
import com.ywsoftware.oa.common.partner.emay.sdkhttp.StatusReport;
...
public class Client {
    ...
    public List<Mo> getMO() throws RemoteException {
        ...
        return mo == null ? null : Arrays.asList(mo);
    }
    ...
    public List<StatusReport> getReport()
        ...
        return sr == null ? null : Arrays.asList(sr);
    }
